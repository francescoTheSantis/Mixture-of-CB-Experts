"""
Script adapted from: https://github.com/mvandenhi/SCBM/blob/main/datasets/cifar100_dataset.py
"""
...
def _check_cifar_data_exists(datapath, cifar_name="cifar100"):
...
def _create_cifar_concepts(cifar_name="cifar100"):
...
def get_CIFAR100_CBM_dataloader(datapath, selected_idxs=None):
    ...
    if not _check_cifar_data_exists(datapath, "cifar100"):
        _create_cifar_concepts("cifar100")
...
if __name__ == "__main__":
    train_loader, test_loader = get_CIFAR100_CBM_dataloader(DATA_PATH)
